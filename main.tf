...
variable "lastname" {
  default = "anju" # REPLACE with your last name
}
variable "github_repo" {
  default = "anju16031998/assignment3" # REPLACE with your GitHub user/repo
}
variable "codestar_arn" {
  default = "arn:aws:codeconnections:us-east-1:002540790985:connection/0f8b57a3-bc16-4b75-8d38-d24d1da8042a" # REPLACE with your Connection ARN
}
...
resource "aws_ecs_cluster" "cluster" { name = "${var.lastname}-cluster" }
...
resource "aws_s3_bucket" "artifacts" {
  bucket        = "${var.lastname}-pipeline-artifacts-${random_id.suffix.hex}"
  force_destroy = true
}
